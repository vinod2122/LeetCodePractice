...
1 <= extraStudents <= 105
 */
public class Solution15_Dec_24 {
    public double maxAverageRatio(int[][] classes, int extraStudents) {
        // Max heap to store classes based on the potential improvement in pass ratio
        ...
        while (extraStudents-- > 0) {
            ...
            // Add one student and recompute improvement
            pass++;
            total++;
            double newImprovement = getImprovement(pass, total);
            maxHeap.offer(new double[]{newImprovement, pass, total});
        }
    ...
    private double getImprovement(int pass, int total) {
